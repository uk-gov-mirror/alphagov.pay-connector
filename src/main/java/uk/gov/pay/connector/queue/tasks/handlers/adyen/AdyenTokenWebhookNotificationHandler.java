...
public class AdyenTokenWebhookNotificationHandler {
    ...
    @Inject
    public AdyenTokenWebhookNotificationHandler(PaymentInstrumentDao paymentInstrumentDao, AgreementDao agreementDao, ChargeDao chargeDao, LinkPaymentInstrumentToAgreementService linkPaymentInstrumentToAgreementService, AdyenRecurringTokenNotificationService adyenRecurringTokenNotificationService) {
