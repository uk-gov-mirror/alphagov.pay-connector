...
public class StripeResourceAuthorizeITest {
    ...
    public void shouldAuthoriseChargeWithoutBillingAddress() {
        ...
        verify(postRequestedFor(urlEqualTo("/v1/tokens"))
                .withHeader("Content-Type", equalTo(APPLICATION_FORM_URLENCODED))
                .withRequestBody(matching(constructExpectedTokensRequestBodyWithoutBillingAddress())));
    ...
    private String constructExpectedTokensRequestBody() {
        ...
        params.add(new BasicNameValuePair("card[addressLine1]", ADDRESS_LINE_1));
        params.add(new BasicNameValuePair("card[addressLine2]", ADDRESS_LINE_2));
        params.add(new BasicNameValuePair("card[addressCity]", ADDRESS_CITY));
        params.add(new BasicNameValuePair("card[addressCountry]", ADDRESS_COUNTRY_GB));
        params.add(new BasicNameValuePair("card[addressZip]", ADDRESS_POSTCODE));
